	...
	*/
	...
	function DisplayRelativeComplimentVCO(area) {
		var resultList = set.relativeCompliment(listA, listB); // call and get the intersection
		var html = getListAHtml() + getListBHtml() + getResultListHtml(resultList);
		setMarketingAreaHeight(listA, listB, resultList);
		showForm(area, html);
	}
	
	function DisplaySymetricDifferenceVCO(area) {
		var resultList = set.symetricDifference(listA, listB); // call and get the intersection
		var html = getListAHtml() + getListBHtml() + getResultListHtml(resultList);
		setMarketingAreaHeight(listA, listB, resultList);	
		showForm(area, html);
	}
